package com.amosh.combyne_movieapp.repository
...
import com.amosh.combyne_movieapp.util.Constants.PAGE_SIZE
import com.amosh.combyne_movieapp.util.addIfNotExistAndNotNull
...
constructor(
    ...
    suspend fun getMovies(
        ...
        val networkMovies = apolloClient.query(GetMoviesQuery(first, skip)).await()
